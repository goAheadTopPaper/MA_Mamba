...
from layers.HybridMixtureExperts import MoAffine
    ...
    def forward(self, x, attn_mask=None, tau=None, delta=None):
        ...
        if self.conv_layers is not None:
            ...
            for i in range(len(self.attn_layers)):
                x, attn = self.attn_layers[i](x, attn_mask=attn_mask, tau=tau, delta=delta)
                attns.append(attn)
